...
function displayPics(){
  ...
  // `let` is block scoped, so can only be referenced WITHIN the code block in which it is declared aka within the `displayPics` function. If we move `console.log(rando)` up one line into the function, we get rid of the error and see the console log.
  console.log(viewed);
